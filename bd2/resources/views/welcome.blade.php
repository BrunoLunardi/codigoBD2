...
<div class="container">
    <div class="panel-group" style="text-align: center; margin-left: 125px;">
        <table>
            ...
            <div class="panel panel-info animatedLong fadeIn" style="height: 350px;">

            <div class="panel-heading animatedLong fadeInDown" style="text-align: center;">
            <i class="material-icons" style="font-size:50px;">school</i>
            <h3>Banco de Dados
            </div>
            <div class="panel-body animatedLong fadeInLeft">
            <table>
            ...
            <td>
            <div class="panel panel-success animatedLong fadeIn" style="height: 350px;">
            <div  class="panel-heading animatedLong fadeInDown">
            <i class="material-icons" style="font-size:50px;">event_note</i>
            <h3>Relatórios
            </div>
            <div class="panel-body animatedLong fadeInRight">
            <table>
            <tr>
            ...
            <a href="{{'index.php/geoRelatorioEst/'}}" class="btn btn-success" style="width: 200px;">Relatório GeoEspacial</a>
            </div>
            </div>
            </td>
            </tr>
